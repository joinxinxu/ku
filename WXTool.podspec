#
#  Be sure to run `pod spec lint WXTool.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "xinxu.wang"
  # spec.authors            = { "xinxu.wang" => "xinxu.wang@oqiji.com" }
  # spec.social_media_url   = "https://twitter.com/xinxu.wang"
  ...
  spec.source       = { :git => "http://EXAMPLE/WXTool.git", :tag => "#{spec.version}" }
